	...
	return (
		<>
			<section className='pt6 '>
				<h1 className=' moon-gray f3'>About</h1>
				<p className='measure-wide center ma3 pv3 ph5-l ph4-m ph3-ns light-green b'>
				...
				<img className='br-100 ba bw2 b--white h5 w5' src={profilePic.src || profilePic} alt='profilePic' />
			</section>
		</>
	);
};
